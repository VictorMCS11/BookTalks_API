...
app.use(cors({
    origin: ['https://booktalks.es', 'http://192.168.1.107:5173', 'http://192.168.1.107:5174', 'http://localhost:5173', 'http://localhost:5174'],  // Permite todos los orígenes (no recomendado en producción),
